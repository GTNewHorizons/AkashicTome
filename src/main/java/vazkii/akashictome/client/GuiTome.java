...
public class GuiTome extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GL11.glLoadIdentity();
        GL11.glViewport(
                (res.getScaledWidth() - 320) / 2 * res.getScaleFactor(),
                (res.getScaledHeight() - 240) / 2 * res.getScaleFactor(),
                320 * res.getScaleFactor(),
                240 * res.getScaleFactor());
        ...
        if (tooltipStack != null) {
            String name = ItemNBTHelper
                    .getString(tooltipStack, MorphingHandler.TAG_TOME_DISPLAY_NAME, tooltipStack.getDisplayName());
            ...
            vazkii.akashictome.utils.RenderHelper
                    .renderTooltip(mouseX, mouseY, Arrays.asList(new String[] { name, mod }));
